...
public class RetrievePurchase extends JFrame{
    ...
    static final String DEFAULT = "SELECT PurchaseID,ScheduleID,SeatID,PurchaseDate,CustomerName,CustomerContact,CustomerIC FROM PURCHASEORDER";
    ...
    private class ReadListener implements ActionListener{
       ...
       try{ 
            ...
            query = "SELECT * FROM PurchaseOrder WHERE PurchaseID= '"+filterText.getText()+ "'";
