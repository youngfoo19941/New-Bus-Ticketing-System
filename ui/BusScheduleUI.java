...
public class BusScheduleUI extends JFrame{ 
    ...
    ImageIcon aBus = new ImageIcon(getClass().getResource("/images/Schedule Create Icon_1.fw.png"));
    private JButton jbtAdd = new JButton(aBus);
    ImageIcon aBus1 = new ImageIcon(getClass().getResource("/images/Schedule Create Icon.fw.png"));
    private JButton jbtAdd1 = new JButton(aBus1);
    
    ImageIcon rBus = new ImageIcon(getClass().getResource("/images/Schedule Retrieve Icon_1.fw.png"));
    private JButton jbtRetrieve = new JButton(rBus);
    ImageIcon rBus1 = new ImageIcon(getClass().getResource("/images/Schedule Retrieve Icon.fw.png"));
    private JButton jbtRetrieve1 = new JButton(rBus1);
    
    ImageIcon uBus = new ImageIcon(getClass().getResource("/images/Schedule Update Icon_1.fw.png"));
    private JButton jbtUpdate = new JButton(uBus);
    ImageIcon uBus1 = new ImageIcon(getClass().getResource("/images/Schedule Update Icon.fw.png"));
    private JButton jbtUpdate1 = new JButton(uBus1);
    
    ImageIcon dBus = new ImageIcon(getClass().getResource("/images/Schedule Delete Icon_1.fw.png"));
    private JButton jbtDelete = new JButton(dBus);
    ImageIcon dBus1 = new ImageIcon(getClass().getResource("/images/Schedule Delete Icon.fw.png"));
    private JButton jbtDelete1 = new JButton(dBus1);
    Staff staff = new Staff();
public BusScheduleUI(Staff staff) {
    this.staff=staff;    
    ...
    setLayout(new FlowLayout());
        ...
        jbtAdd.addActionListener(new addSchedule());
        jbtRetrieve.addActionListener(new retrieveSchedule());
        jbtUpdate.addActionListener(new editSchedule());
        jbtDelete.addActionListener(new deleteSchedule());
...
private class addSchedule implements ActionListener{
    @Override
...
private class retrieveSchedule implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new RetrieveSchedule();
    }
}

private class editSchedule implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new UpdateSchedule();
    }
...
private class deleteSchedule implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new DeleteSchedule();
    }
