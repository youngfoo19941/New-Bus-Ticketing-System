...
public class InsuranceUI extends JFrame{ 
    ...
    ImageIcon aInsurance = new ImageIcon(getClass().getResource("/images/Insurance Create Icon_1.fw.png"));
    private JButton jbtAdd = new JButton(aInsurance);
    ImageIcon aInsurance1 = new ImageIcon(getClass().getResource("/images/Insurance Create Icon.fw.png"));
    private JButton jbtAdd1 = new JButton(aInsurance1);
    
    ImageIcon rInsurance = new ImageIcon(getClass().getResource("/images/Insurance Retrieve Icon_1.fw.png"));
    private JButton jbtRetrieve = new JButton(rInsurance);
    ImageIcon rInsurance1 = new ImageIcon(getClass().getResource("/images/Insurance Retrieve Icon.fw.png"));
    private JButton jbtRetrieve1 = new JButton(rInsurance1);
    
    ImageIcon uInsurance = new ImageIcon(getClass().getResource("/images/Insurance Update Icon_1.fw.png"));
    private JButton jbtUpdate = new JButton(uInsurance);
    ImageIcon uInsurance1 = new ImageIcon(getClass().getResource("/images/Insurance Update Icon.fw.png"));
    private JButton jbtUpdate1 = new JButton(uInsurance1);
    
    ImageIcon dInsurance = new ImageIcon(getClass().getResource("/images/Insurance Delete Icon_1.fw.png"));
    private JButton jbtDelete = new JButton(dInsurance);
    ImageIcon dInsurance1 = new ImageIcon(getClass().getResource("/images/Insurance Delete Icon.fw.png"));
    private JButton jbtDelete1 = new JButton(dInsurance1);
    Staff staff = new Staff();
public InsuranceUI(Staff staff) {
        this.staff=staff;
    
    setTitle("Insurance Page");
    ...
    setLayout(new FlowLayout());
        ...
        jbtAdd.addActionListener(new addInsurance());
        jbtRetrieve.addActionListener(new retrieveInsurance());
        jbtUpdate.addActionListener(new editInsurance());
        jbtDelete.addActionListener(new deleteInsurance());
...
private class addInsurance implements ActionListener{
    @Override
...
private class retrieveInsurance implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
...
private class editInsurance implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new UpdateInsurance();
        //setVisible(false);
...
private class deleteInsurance implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new DeleteInsurance();
        //setVisible(false);
