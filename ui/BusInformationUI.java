...
public class BusInformationUI extends JFrame{ 
    ...
    ImageIcon aBus = new ImageIcon(getClass().getResource("/images/Bus Info Create Icon_1.fw.png"));
    private JButton jbtAdd = new JButton(aBus);
    ImageIcon aBus1 = new ImageIcon(getClass().getResource("/images/Bus Info Create Icon.fw.png"));
    private JButton jbtAdd1 = new JButton(aBus1);
    
    ImageIcon rBus = new ImageIcon(getClass().getResource("/images/Bus Info Retrieve Icon_1.fw.png"));
    private JButton jbtRetrieve = new JButton(rBus);
    ImageIcon rBus1 = new ImageIcon(getClass().getResource("/images/Bus Info Retrieve Icon.fw.png"));
    private JButton jbtRetrieve1 = new JButton(rBus1);
    
    ImageIcon uBus = new ImageIcon(getClass().getResource("/images/Bus Info Update Icon_1.fw.png"));
    private JButton jbtUpdate = new JButton(uBus);
    ImageIcon uBus1 = new ImageIcon(getClass().getResource("/images/Bus Info Update Icon.fw.png"));
    private JButton jbtUpdate1 = new JButton(uBus1);
    
    ImageIcon dBus = new ImageIcon(getClass().getResource("/images/Bus Info Delete Icon_1.fw.png"));
    private JButton jbtDelete = new JButton(dBus);
    ImageIcon dBus1 = new ImageIcon(getClass().getResource("/images/Bus Info Delete Icon.fw.png"));
    private JButton jbtDelete1 = new JButton(dBus1);
    Staff staff = new Staff();
public BusInformationUI(Staff staff) {
    ...
    setLayout(new FlowLayout());
        ...
        jbtRetrieve.addActionListener(new retrieveBus());
        jbtUpdate.addActionListener(new updateBus());
        jbtDelete.addActionListener(new deleteBus());
...
private class addBus implements ActionListener{
    @Override
...
private class retrieveBus implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new RetrieveBusInfo();
    }
...
private class updateBus implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new UpdateBusInfo();
    }
...
private class deleteBus implements ActionListener{
    @Override
    public void actionPerformed(ActionEvent e){
        new DeleteBusInfo();
    }
