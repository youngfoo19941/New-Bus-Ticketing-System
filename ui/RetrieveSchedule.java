...
public class RetrieveSchedule extends JFrame{
    ...
    private JButton Read = new JButton("Read Schedule ID");
    ...
    public RetrieveSchedule(){
        try {
            ...
            r.setBorder(new TitledBorder("Schedule Information"));
            r.add(filterText);
            r.add(Read);
            r.add(Reset);
    ...
    private class ReadListener implements ActionListener{
       ...
       try{ 
            ...
            query = "SELECT * FROM SCHEDULE WHERE SCHEDULEID= '"+filterText.getText()+"'";
            ...
            try {
                ...
                try {
                    ...
                    if(filterText.getText().equals(""))
                    {
                        JOptionPane.showMessageDialog(null, "Schedule ID can't be empty !", "INVALID TYPE", JOptionPane.ERROR_MESSAGE);
                        filterText.setText("");
                    }
                    else{
